...
var sketch = function(processing) {
    with(processing) {
        ...
        var whiteFlowers = [];//contains whiteFlower x, y, and object
...
//to make whiteFlower appear when mouse is clicked        
mouseClicked = function() {
    whiteFlowers.push({ x: mouseX, y: mouseY, angle: random(6.28) });
    };
