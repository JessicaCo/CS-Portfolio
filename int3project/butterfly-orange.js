...
var sketch = function(processing) {
    with(processing) {
        ...
        var butterflies = [];//contains butterfly x, y, and object
        ...
        draw = function() {
            ...
            //draws butterfly and keeps it where it is drawn
            for (var i = 0; i < butterflies.length; i++) {
                butterfly(butterflies[i].x, butterflies[i].y, butterflies[i].angle);
            }
        };
        
function butterfly(x, y, angle) {
...
//to make butterfly appear when mouse is clicked        
mouseClicked = function() {
    butterflies.push({ x: mouseX, y: mouseY, angle: random(6.28) });
    };
